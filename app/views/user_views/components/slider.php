...
<div class="swiper-container swiper-parent">
    <div class="swiper-wrapper">
        <div class="swiper-slide dark">
            ...
            <div class="swiper-slide-bg" style="background-image: url('../../../public/user_public/demos/shop/images/slider/1.jpg');"></div>
        </div>
        <div class="swiper-slide dark">
            <div class="container">
                <div class="slider-caption slider-caption-center">
            ...
            <div class="swiper-slide-bg" style="background-image: url('../../../public/user_public/demos/shop/images/slider/3.jpg'); background-position: center 20%;"></div>
        </div>
        <div class="swiper-slide dark">
            <div class="container">
                <div class="slider-caption slider-caption-center">
            ...
            <div class="swiper-slide-bg" style="background-image: url('../../../public/user_public/demos/shop/images/slider/2.jpg'); background-position: center 40%;"></div>
        </div>
    </div>
