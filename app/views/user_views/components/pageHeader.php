			...
			<div class="header-row justify-content-lg-between">
				...
				<div id="logo" class="me-lg-4">
					...
					<a href="../../views/user_views/index.php" class="retina-logo"><img
							src="../../../public/user_public/demos/shop/images/logo@2x.png" alt="Canvas Logo"></a>
				</div><!-- #logo end -->
				...
				<div class="header-misc">
					...
					<div id="top-account">
						...
						// display user email
						echo '<i class="icon-line2-user me-1 position-relative" style="top: 1px;"></i><span class="d-none d-sm-inline-block font-primary fw-medium">' . $_SESSION['user']['name'] . '</span>';
						?>
							...
							<div class="top-cart-items">
								<div class="top-cart-item">
									<div class="top-cart-item-image">
										<a href="#"><img src="../../../public/user_public/images/shop/small/1.jpg"
								...
								<div class="top-cart-item">
									<div class="top-cart-item-image">
										<a href="#"><img src="../../../public/user_public/images/shop/small/6.jpg"
				...
				<form class="top-search-form" action="../../views/user_views/search.php" method="get">
					<input type="text" name="keyword" class="form-control" value=""
						placeholder="Category &amp; Product Enter.." autocomplete="off">
				</form>
