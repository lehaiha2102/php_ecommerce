...
<body class="stretched">
	...
	<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			...
			<div class="modal-body">
				...
				<label for="shipping-form-address">Address:</label><br>
				<input type="text" name="add_address_user">	<br>
 ...
 <!-- JavaScripts
	...
	============================================= -->
	<!-- SweetAlert CDN -->
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/sweetalert2@11.0.19/dist/sweetalert2.min.css" integrity="sha384-pmAxkCpgdW7ykgX0uUG7VU1f6Lg7Vahx/J6uP7pdrhC6d1z0ibOTX9h1XYiFh3o3" crossorigin="anonymous">
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11.0.19/dist/sweetalert2.min.js" integrity="sha384-jg01RZVRK/KeYGOw+3q3cq/3zgT9LRBpmyTmjlLgzjbRxiaZ/n4nc4H4YwQt34Mf" crossorigin="anonymous"></script>
